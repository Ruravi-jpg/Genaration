Array.prototype.remove = function(el) {
  ...
  function play(instrument, key, state){
    var instrumentName = Object.keys(InstrumentEnum).find(k => InstrumentEnum[k] === instrument).toLowerCase(); //encuentra el nombre del instrumento en el enum
    var commonKey = KeyEnum[key];

    var id = "#" + "paw-" + ((instrument == InstrumentEnum.BONGO ? commonKey : commonKey <= 5 && commonKey != 0 ? 0 : 1) == 0 ? "left" : "right");
